...
export default function ReviewPurchaseModal(props) {
             ...
             <View style={styles.innerContainer}>
                 <EvilIcons name="close-o" style={styles.image} onPress={props.closePopup}/>   
                  <View style={styles.innerdetail}>
                     <Text style={styles.innerText}>Review Your Purchase</Text>
                     <Text style={styles.ratingText}>Quality of Product</Text>
                      ...
                      <TextInput placeholder="Type your review" style={styles.inputStyle} underlineColorAndroid="transparent" onChangeText={props.comments}/>
